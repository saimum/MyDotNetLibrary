...
{
    public partial class VehicleWeightTransaction
    {
        [Key]
        ...
        public DateTime? EntryDatetime_First { get; set; }
        ...
        public DateTime? EntryDatetime_Second { get; set; }
    ...
    public partial class VehicleWeightTransaction
    {
        ...
        [ForeignKey("FkMaterial")]
        public virtual Material Material { get; set; }

        [ForeignKey("FkClientParty")]
        public virtual ClientParty ClientParty { get; set; }

        [ForeignKey("FkBridgingScaleMeter_First")]
        public virtual BridgingScaleMeter BridgingScaleMeter_First { get; set; }

        [ForeignKey("FkUserEntity_First")]
        public virtual UserEntity UserEntity_First { get; set; }

        [ForeignKey("FkBridgingScaleMeter_Second")]
        public virtual BridgingScaleMeter BridgingScaleMeter_Second { get; set; }

        [ForeignKey("FkUserEntity_Second")]
        public virtual UserEntity UserEntity_Second { get; set; }
    }
}

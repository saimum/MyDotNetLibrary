...
namespace TheIdealProject_Web_MVC.Models
{
    ...
    {
        public long TmProductPk { get; set; }
        public Nullable<long> Product_TlProductFk { get; set; }
        ...
        public virtual Tm_Category Tm_Category { get; set; }
        public virtual Tm_User Tm_User { get; set; }
        public virtual Tm_User Tm_User1 { get; set; }
    }
}
